<div class="flex justify-between items-center my-6">
    ...
    @isset($modal)
        <button type="button" data-bs-toggle="modal" data-bs-target="#loginModal" class="text-sm text-blue-800">
...
<form action="{{ route('register') }}" method="POST">
    ...
    <div class="mb-4">
        ...
        <input type="password" name="password" class="form-input py-2 mt-2 @error('password') form-invalid @enderror">
        @error('password')
        <span class="text-sm text-red-500" role="alert">
            <strong>{{ $message }}</strong>
        </span>
